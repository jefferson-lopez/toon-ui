  ...
  const lastStructuredMessage = useMemo(
    () =>
      [...messages]
        ...
        .find(
          (message) =>
            message.kind === "ui_reply" || message.kind === "ui_submit",
        ),
    [messages],
  );
    ...
    >
      ...
      >
        <header>
          ...
          <p style={{ marginBottom: 0, color: "#4b5563" }}>
            Chat host real con loop de interacción estructurada. El modelo
            recibe `content`; el humano ve `displayContent`.
          </p>
        </header>
          ...
          {messages.map((message) => (
            <article
              ...
              style={{
                ...
                maxWidth: "85%",
                background:
                  message.role === "assistant" ? "#f9fafb" : "#dbeafe",
                borderRadius: 14,
                padding: 14,
                whiteSpace: "pre-wrap",
                display: "grid",
        ...
        <footer style={{ display: "grid", gap: 12 }}>
          ...
          <div style={{ display: "flex", gap: 12 }}>
            ...
            <button
              onClick={() => setDraft("crear producto")}
              style={{
                borderRadius: 10,
                padding: "10px 14px",
                background: "#e5e7eb",
            ...
            <button
              onClick={() => setDraft("eliminar producto")}
              style={{
                borderRadius: 10,
                padding: "10px 14px",
                background: "#fee2e2",
      ...
      >
        ...
        <div>
          ...
          >
            {lastStructuredMessage?.content ??
              "Aún no hay eventos ui_reply/ui_submit."}
          </pre>
        </div>
        ...
        <div>
          ...
          >
            {lastStructuredMessage?.displayContent ??
              "Aún no hay displayContent visible."}
          </pre>
        </div>
      </aside>
    </div>
